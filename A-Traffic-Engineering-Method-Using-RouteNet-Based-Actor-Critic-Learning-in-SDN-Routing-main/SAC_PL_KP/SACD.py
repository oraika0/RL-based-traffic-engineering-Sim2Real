...
class SACD:
    def __init__(self, hp, device=None):
        ...
        self.actor.policy_net.message.flatten_parameters()
        ...
        self.critic.Q1_net.message.flatten_parameters()
        self.critic.Q2_net.message.flatten_parameters()
        self.c_optimizer = optim.AdamW(self.critic.parameters(), lr=hp['c_lr'])
        self.critic_target = copy.deepcopy(self.critic)
        self.critic_target.Q1_net.message.flatten_parameters()
        self.critic_target.Q2_net.message.flatten_parameters()
    ...
    def input_transform(self, env, src, dst, demand):
        ...
        temp = {
            ...
            'capacity': env.link_capacity_feature, # normalized in env 
